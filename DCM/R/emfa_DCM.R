emfa_DCM <- function (data, nbf, x = 1, test = x[1], pvalues = NULL, min.err = 0.001) 
{
    ...
    res = list(B = B, Psi = Psi, Factors = Factors, commonvar = commonvar)
    return(res)
}